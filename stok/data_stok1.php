    ...
    <div class="col-lg-12">
        <div class="page-header">
            ...
            <div class="text-right" style="margin-top: -4%;">
                <a href="stok/cetak_stokk.php" target="_blank" class="btn btn-default " styles=""><i class="fa fa-print "></i> Print </a>
            </div>
        </div>
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['cari'])) {
                            $cari = $_GET['cari'];
                            $data = mysqli_query($conn, "select * from tbl_stok where kode_barang like '%" . $cari . "%' || nama_barang like '%" . $cari . "%'");
                        } else {
