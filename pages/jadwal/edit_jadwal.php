...
// Ambil data
$kode  = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM tbl_jadwal_pemeliharaan WHERE kode_jadwal='$kode' LIMIT 1");
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        Edit Jadwal Pemeliharaan Inventaris
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-6">
            <form action="pages/jadwal/proses.php?aksi=update" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>Kode Jadwal</label>
                <input type="text" name="kode" value="<?= $data['kode_jadwal'] ?>" class="form-control" readonly>
              </div>
              <div class="form-group">
                <label>Tanggal Pemeliharaan</label>
                <input type="date" value="<?= $data['tgl'] ?>" name="tgl" class="form-control" required>
              </div>
              <div class="form-group">
